  ...
  async createPermit(insertPermit: InsertPermit): Promise<Permit> {
    ...
    const [permit] = await db
      ...
      .values({
        ...
        preWorkMeasuresSignature: insertPermit.preWorkMeasuresSignature || null,
        preWorkMeasuresDate: insertPermit.preWorkMeasuresDate || null,
        workRemovalSignature: insertPermit.workRemovalSignature || null,
        workRemovalDate: insertPermit.workRemovalDate || null,
